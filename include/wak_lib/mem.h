...
inline int alloc_will_overflow(size_t count, size_t elem_size) {
...
*/
inline void alloc_prevent_overflow(size_t count, size_t elem_size) {
 ...
 */
inline void* _array_alloc_impl(size_t count, size_t elem_size) {
